...
import 'package:restaurant2/pages/customer/category_list_product_page.dart';
import 'package:restaurant2/pages/customer/product_detail_page.dart';
import 'package:restaurant2/services/firestore_service.dart';
import 'package:restaurant2/utils/search_product.dart';
import 'package:restaurant2/widgets/category_filter_widget.dart';
import 'package:restaurant2/widgets/item_carousel_widget.dart';
import 'package:restaurant2/widgets/text_normal_widget.dart';
          ...
          child: SingleChildScrollView(
            child: Column(
              children: [
                ...
                FutureBuilder(
                    future: _productFirestoreService.getProductHome(categoryId: "HoF5EaanSTj56KJ9UFUi"),
                ...
                FutureBuilder(
                    future: _productFirestoreService.getProductHome(categoryId: "Px6UfYKQXA35ct0r0eUU"),
                    builder: (BuildContext context, AsyncSnapshot snap){
                      if(snap.hasData){
                        List<Map<String, dynamic>> products = snap.data;
                        return SingleChildScrollView(
